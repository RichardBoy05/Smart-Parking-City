...
La mappa illustra un percorso stradale che presenta tre tipologie di parcheggio distinte, ciascuna con le proprie peculiarità e scopi dimostrativi.
...
| --- | --- | --- |
| [`Arduino UNO R4 WiFi`](https://docs.arduino.cc/hardware/uno-r4-wifi/) | 1 | **Arduino** è una piattaforma hardware e software *open-source* con cui realizzare dispositivi digitali in grado di interagire con il mondo esterno attraverso sensori e attuatori. |
